...
3. I can ask Wolfram for its curated knowledgebase or scientific computation. I write the query in a simple structure or in Wolfram language.
4. I can ask Web to send a request. The query should be a URL.`
